...
router.use("/:name", (req, res) => {
    ...
    <g transform="matrix(1 0 0 1 600 600)" style="" id="f22f7313-cde1-4bee-8225-270bc85b9611"  >
            <text xml:space="preserve" font-family="Lato" font-size="105" font-style="normal" font-weight="900" style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-dashoffset: 0; stroke-linejoin: miter; stroke-miterlimit: 4; fill: rgb(0,0,0); fill-rule: nonzero; opacity: 1; white-space: pre;" ><tspan x="-265.44" y="32.98" style="fill: rgb(229,0,115); ">${name}</tspan><tspan y="32.98" >.wtf</tspan></text>
    </g>
    </svg>
    `)
})
